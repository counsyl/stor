...
class TestWalkFilesAndDirs(unittest.TestCase):
    def test_w_dir(self):
        ...
        # in
        swift_dir = (
            stor.path(__file__).expand().abspath().parent /
            'swift_upload'
        )
